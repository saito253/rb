...
print("DSSS 200kcps TEST ===========================>")
    ...
    p sp.gets()
    sleep 0.5
    print("Check the center frequency is 921MHz:")
    gets()
    sp.puts("rfr,0,0x09")
    p sp.gets()
    sleep 0.5
    sp.puts("rfw,0,0x09,0x00")
    p sp.gets()
    sleep 0.5
...
print("DSSS 100kcps TEST ===========================>")
    ...
    p sp.gets()
    sleep 0.5
    print("Check the center frequency is 920.7MHz:")
    gets()
    sp.puts("rfr,0,0x09")
    p sp.gets()
    sleep 0.5
...
print("SigFox 100bps TEST ===========================>")
    ...
    p sp.gets()
    sleep 0.5
    print("Check the center frequency is 920.6MHz:")
    gets()
    sp.puts("rfr,0,0x09")
    p sp.gets()
    sleep 0.5
